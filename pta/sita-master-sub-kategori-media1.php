  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <ul class="nav nav-tabs mb-3">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="sita-master-sub-kategori-media1.php"><i class="fas fa-list me-1"></i> Daftar Kategori Media</a>
        </li>
        <li class="nav-item">
                ...
                <table class="table table-bordered table-striped table-sm datatables1">
                  ...
                  <tbody>
                    ...
                    $rows = [
                      ...
                      ['Skripsi','Jurnal','Jurnal Internasional'],
                      ['Skripsi','Jurnal','Jurnal Nasional'],
                      ['Skripsi','Prosiding','Prosiding Konferensi Internasional'],
                      ['Skripsi','Prosiding','Prosiding Konferensi Nasional'],
                      ['Skripsi','Media Massa','Media Ilmiah/Populer Cetak'],
                      ['Skripsi','Media Massa','Media Daring'],
                      ['Skripsi','Poster Konferensi','Poster Konferensi Internasional'],
                      ['Skripsi','Poster Konferensi','Poster Konferensi Nasional'],
                      ['Magang','Jurnal','Jurnal Internasional'],
                      ['Magang','Jurnal','Jurnal Nasional'],

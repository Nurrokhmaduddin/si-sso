...
<div class="row g-3 mb-3">
 ...
 <!-- TAB NAV (Semester) -->
           <ul class="nav nav-tabs">
            <li class="nav-item" onclick="window.location='monev-magang.php'"><a class="nav-link ">Berlangsung</a></li>
            <li class="nav-item" onclick="window.location='monev-magang2.php'"><a class="nav-link active">Selesai</a></li>
          </ul>
  <!-- ========== CARD : Chart ========== --> 
  <div class="card">

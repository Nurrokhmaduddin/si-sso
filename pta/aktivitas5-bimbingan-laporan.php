      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0"><i class="fas fa-filter "></i> 5. Bimbingan Laporan<button type="button" class="btn btn-tool" data-bs-toggle="modal" data-bs-target="#modalBantuan" title="Bantuan">
        ...
        <tbody>
            <tr>
                ...
                <td>2025-02-01</td>
                <td>-</td>
                <td>/uploads/laporan.pdf</td>
                <td>Revisi Bab 4</td>
                <td>
                	<button 
                	class="btn btn-sm btn-info"
                	onclick="window.location.href='aktivitas5_detail.php'">
                	Detail
                </button>

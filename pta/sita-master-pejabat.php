...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Pejabat Fakultas
      ...
      <table class="table table-bordered table-striped table-sm datatables1">
        ...
        <tbody>
          ...
          $rows = [
            ...
            [
              'Sekretaris Prodi Manajemen Program Reguler',
              '153110102',
            ...
            [
              ...
              '943120101',
              'Prof. Johan Arifin, S.E., M.Si., Ph.D.'
            ],

            [
              'Sekretaris Prodi Manajemen Program Internasional',
              '163110101',

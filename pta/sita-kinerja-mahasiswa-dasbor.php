  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <ul class="nav nav-tabs mb-3">
        <li class="nav-item">
          <a class="nav-link active" href="sita-kinerja-mahasiswa-dasbor.php"><i class="fas fa-chart-pie me-1"></i> Dashboard</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="sita-kinerja-mahasiswa-daftar.php"><i class="fas fa-list me-1"></i> Daftar</a>
        </li>
      </ul>
                ...
                <table class="table table-bordered table-striped table-sm datatables1">
                  ...
                  <tbody>
                    ...
                    $rows = [
                      ...
                      ['2022', 'Skripsi', 50, 0, 195, 79.16],
                      ['2022', 'RBB', 9, 8, 128, 64.44],
                      ['2022', 'Magang', 108, 0, 200, 73.78],

                      ['2021', 'Skripsi', 185, 0, 203, 97.16],
                      ['2021', 'RBB', 8, 4, 189, 93.50],
                      ['2021', 'Magang', 126, 0, 200, 100.80],

                      ['2020', 'Skripsi', 183, 0, 206, 91.95],
                      ['2020', 'RBB', 20, 1, 135, 60.75],
                      ['2020', 'Magang', 136, 0, 203, 94.58],

                      ['2019', 'RBB', 5, 0, 150, 70.40],
                    ...
                    foreach ($rows as $r):
                      ...
                      <tr>
                        ...
                        <td class="text-center"><?= number_format($r[5], 2); ?></td>

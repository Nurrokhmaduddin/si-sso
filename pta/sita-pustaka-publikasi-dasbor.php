  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <ul class="nav nav-tabs mb-3">
        <li class="nav-item">
          <a class="nav-link active" href="sita-pustaka-publikasi-dasbor.php"><i class="fas fa-chart-pie me-1"></i> Dashboard</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="sita-pustaka-publikasi-daftar.php"><i class="fas fa-list me-1"></i> Daftar</a>
        </li>
      </ul>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-striped table-sm datatables1">
                  ...
                  <tbody>
                    ...
                    <?php
                    // Dummy data mockup — ganti dengan query sesungguhnya pada implementasi final
                    $rows = [
                      ['2025/Ganjil', 'Magang', 70, 0.00,  '-',       '-',                              '-'],
                      ['2025/Ganjil', 'Magang', 10, 90.00, 'Jurnal',  'Jurnal Internasional',            'Terindeks EBSCO/DOAJ/Proquest/Copernicus/IEEE'],
                      ['2025/Ganjil', 'Magang', 1,  100.00,'Jurnal',  'Jurnal Nasional',                 'Sinta 2'],
                      ['2025/Ganjil', 'Magang', 56, 94.64, 'Jurnal',  'Jurnal Nasional',                 'Sinta 3'],
                      ['2025/Ganjil', 'Magang', 21, 90.48, 'Jurnal',  'Jurnal Nasional',                 'Sinta 4'],
                      ['2025/Ganjil', 'Magang', 1,  100.00,'Prosiding','Prosiding Konferensi Internasional','Dipresentasikan Oral & Dimuat di Prosiding'],
                      ['2025/Ganjil', 'RBB',    6,  0.00,  '-',       '-',                              '-'],
                      ['2025/Ganjil', 'RBB',    2,  100.00,'Event Khusus','Event Khusus Skala Lokal',   'Diskusi Panel/External Pitching/Demonstrasi Produk'],
                      ['2025/Ganjil', 'RBB',    1,  100.00,'Event Khusus','Event Khusus Skala Nasional', 'Diskusi Panel/External Pitching/Demonstrasi Produk'],
                      ['2025/Ganjil', 'RBB',    1,  100.00,'Jurnal',  'Jurnal Nasional',                 'Sinta 3'],
                    ];
                    ...
                    <tr>
                      ...
                      <td class="text-center"><?php echo htmlspecialchars($r[2]); ?></td>
                      <td class="text-center"><?php echo number_format($r[3], 2); ?> %</td>

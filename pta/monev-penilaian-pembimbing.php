<?php $page = 'monev_penilaian_pembimbing'; ?>
...
<div class="card">
  <div class="card-header">
    <h5 class="card-title mb-0"><i class="fas fa-chart-bar me-2"></i> Penilaian Bimbingan Tugas Akhir</h5>
    <div class="card-tools">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table id="tableDosen" class="table table-bordered table-striped align-middle datatables1">
        <thead class="text-center">
          <tr>
            <th>NO</th>
            <th>NIDN</th>
            <th>Nama Dosen</th>
            <th>Mahasiswa (sudah/total)</th>
            <th>Total Score</th>
            <th>Index Kinerja Bimbingan</th>
            <th>Aksi</th>
          </tr>
        </thead>
        <tbody>

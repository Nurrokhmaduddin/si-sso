<?php $page = 'monev_kinerja_mahasiswa'; ?>
...
<div class="card">
  <div class="card-header">
    <h5 class="card-title mb-0"><i class="fas fa-chart-bar me-2"></i> Daftar Statistik Kelulusan Bimbingan TA</h5>
    <div class="card-tools">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table id="tableDurasiTA" class="table table-bordered table-striped align-middle">
          
          <thead class="text-center">
            <tr>
              <th>Angkatan</th>
              <th>Jalur TA</th>
              <th>Jumlah Mahasiswa Lulus Bimbingan TA</th>
              <th>Min. Durasi (Hari)</th>
              <th>Max. Durasi (Hari)</th>
              <th>Avg. Durasi (Hari)</th>
            </tr>
          </thead>
          ...
          <tbody>
            <tr>
              ...
              <td class="text-center">121.42</td>
            </tr>
            <tr>
              <td class="text-center">2022</td>
              <td>RBB</td>
            ...
            <tr>
              ...
              <td class="text-center">118.26</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="text-center">106.35</td>
            </tr>
            <tr>
...
<div class="container mt-4">
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <h4 class="fw-bold">Kinerja Mahasiswa</h4>
        </div>
    </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h6 class="text-muted">Bimbingan TA</h6>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h6 class="text-muted">Ujian TA</h6>
                ...
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                Achmad Rizal, SE., MSc. Fin.<br>
                                Katiya Nahda, S.E., M.Sc.
                            </td>
                            <td>2026-02-21 13:55:20</td>
                            <td>2026-03-05 13:58:54</td>
                            <td>-</td>
                        ...
                        <tr>
                            <td>52</td>
                            <td>22311345</td>
                            <td>Delina Virna Varida</td>
                            <td>Magang</td>
                            <td>Ujian Tugas Akhir</td>
                            <td>
                                Sri Mulyati, Dra., M.Si.<br>
                                Kartini, Dra., M.Si.
                            </td>
                            <td>2026-02-21 13:00:48</td>
                            <td>-</td>
                            <td>-</td>
                        ...
                        <tr>
                            ...
                            <td>2026-02-20 13:31:33</td>
                            <td>2026-02-20 14:35:46</td>
                            <td>0</td>
                            <td><span class="badge bg-success">Selesai</span></td>
                        </tr>

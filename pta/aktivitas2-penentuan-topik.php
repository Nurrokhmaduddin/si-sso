        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0"><i class="fas fa-filter "></i> 2. Penentuan Topik Awal<button type="button" class="btn btn-tool" data-bs-toggle="modal" data-bs-target="#modalBantuan" title="Bantuan">
        ...
        <!-- ========== CARD : Tabel  ========== -->
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
               <table class="table table1 table-bordered table-striped table-sm datatables1">
                ...
                <th>Keterangan Reviewer</th>
                <th>Status Validasi Topik</th>
                  </tr>
            ...
            <tr>
                ...
                <td>2025-01-10</td>
                <td>-</td>
                <td>/uploads/topik.pdf</td>
                <td>Perlu revisi judul</td>
                <td>
                    <button class="btn btn-sm btn-info">Detail</button>
                </td>
                <td>Optimalisasi Data Akademik</td>
                <td>Reviewer: OK</td>
                <td>Disetujui</td>
            </tr>
        </tbody>

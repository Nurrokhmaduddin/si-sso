      ...
      <table class="table table-bordered table-striped table-sm datatables1">
        ...
        <tbody>
          ...
          $rows = [
            ...
            [
              'Pengunduran Diri Bimbingan TA',
              '223113550426',
              '2025 - Genap',
              '22311355',
              'Arawinda Nariswari Suprapto',
              '13-07-2026 12:09'
            ],
          ...
          foreach($rows as $r):
            ...
            <tr>
              ...
              <td class="text-center"><?= htmlspecialchars($r[5]); ?></td>

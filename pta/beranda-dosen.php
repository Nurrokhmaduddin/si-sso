   				...
   				<div class="col-lg-12"> 
   					<div class="card p-3"> 
   						<div class="d-flex justify-content-between mb-3"> 
   							<h5 class="mb-3"><i class="fas fa-list-check me-1"></i> Daftar NPC Dibimbing (Taskboard)</h5> <button class="btn btn-sm btn-outline-primary">Taskboard<i class="fas fa-angle-double-right ms-1"></i></button> 
   						</div> 
   						<div class="table-responsive"> 

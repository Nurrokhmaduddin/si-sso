...
<!-- ========== CARD : Filter & Export ========== -->
          ...
          <!-- TAB NAV (Semester) -->
           <ul class="nav nav-tabs">
            <li class="nav-item" onclick="window.location='ta-zend1.php'"><a class="nav-link active">Detail</a></li>
             <li class="nav-item" onclick="window.location='ta-zend2.php'"><a class="nav-link ">Pendaftaran</a></li>
            <li class="nav-item" onclick="window.location='ta-zend.php'"><a class="nav-link ">Bimbingan TA</a></li>
  ...
  <div class="card">
      ...
      <table class="table table-bordered table-hover table-sm">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Perekrutan dan Seleksi</td>
          </tr>
          <tr>
            <td>Tanggal Pendaftaran</td>
            <td>4 Maret 2026 16:26</td>
          </tr>
          <tr>
            <td>Tanggal Kadaluarsa Akun</td>
            <td>15 September 2026 (berakhir pada 6 bulan, 10 hari.)</td>
          </tr>
          <tr>
            <td>Kategori TA</td>
            <td>Magang</td>
          ...
          <tr>
            <td>Pembimbing TA #1</td>
            <td>903110101 - Suhartini, Dra., M.Si. </td>
          </tr>
          <tr>
            <td>Pembimbing TA #2</td>
            <td>903110341 - Dr. Budi </td>
          </tr>
          <tr>
            <td>Penguji TA</td>
            <td>933440341 - Dr. Sari</td>
          </tr>
    ...
    <tfoot>
      <tr class="table-warning">
        <td colspan="2">
        Perhatian: Masa Bimbingan TA Akan Berakhir Pada 15 September 2026 . Jika sebelum tanggal tersebut TA belum dinilai layak oleh Pembimbing, maka akun akan otomatis terkunci dan tidak dapat digunakan untuk pembimbingan. Untuk membuka kembali (unlock) diperlukan PIN Registrasi yang dapat diminta dari Prodi. Oleh karena itu, Checkingan hanya dapat dilakukan 2 kali. Jika TA belum juga dinilai layak oleh Pembimbing sebelum Tanggal Kadaluarsa Akun yang baru, maka mahasiswa harus melakukan registrasi baru dari awal lagi.
        </td>
      </tr>
    </tfoot>
  </table>

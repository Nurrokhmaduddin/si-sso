        ...
        <tbody>
          ...
          $rows = [
            ...
            [
              'SKRIPSI',
              'RUBRIK PENILAIAN TA',
              '1719885571272-rubrik_skripsi.pdf',
              'Active'
            ],
          ...
          foreach($rows as $r):
            ...
            $statusClass = ($r[3]=='Active') ? 'success' : 'secondary';
            ...
            <tr>
              ...
              <td class="text-center">
                <span class="badge badge-primary"><?= $r[0] ?></span>
              </td>
              ...
              <td class="text-center">
                ...
                <a href="#" class="btn btn-xs btn-info" title="Preview">

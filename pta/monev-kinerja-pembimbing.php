...
<div class="card">
  <div class="card-header">
    <h5 class="card-title mb-0"><i class="fas fa-chart-bar me-2"></i> Kinerja Pembimbing</h5>
    <div class="card-tools">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table id="tableKinerjaPembimbing" class="table table-bordered table-striped align-middle">

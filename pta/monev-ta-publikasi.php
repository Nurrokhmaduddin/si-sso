...
<div class="row g-3 mb-3">
 ...
 <!-- TAB NAV (Semester) -->
           <ul class="nav nav-tabs">
            <li class="nav-item" onclick="window.location='monev-ta-publikasi.php'"><a class="nav-link active">Realtime</a></li>
            <li class="nav-item" onclick="window.location='monev-ta-publikasi2.php'"><a class="nav-link ">Historis</a></li>
          </ul>
  <!-- ========== CARD : Chart ========== --> 
  <div class="card">

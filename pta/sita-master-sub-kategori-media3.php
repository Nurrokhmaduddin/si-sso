  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <ul class="nav nav-tabs mb-3">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="sita-master-sub-kategori-media3.php"><i class="fas fa-list me-1"></i> Daftar Bukti Dokumen</a>
        </li>
      </ul>
                ...
                <table class="table table-bordered table-striped table-sm datatables1">
                  ...
                  <tbody>
                    ...
                    $rows = [
                      ...
                      ['Naskah Artikel Final'],
                      ['Letter of Acceptance (LoA)'],
                      ['Sertifikat Presentasi'],
                      ['Naskah Artikel'],
                      ['Sampul Prosiding'],
                      ['Scan Halaman Terbit'],
                      ['Tangkapan Layar Halaman Terbit'],
                      ['Poster'],
                      ['Naskah Bab'],
                      ['Sampul Buku'],

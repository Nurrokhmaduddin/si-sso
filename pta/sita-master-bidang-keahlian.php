      ...
      <table class="table table-bordered table-striped table-sm datatables1">
        ...
        <tbody>
          ...
          $rows = [
            ...
            ['Data Dummy', 'Manajemen Sumber Daya Manusia'],

            ['Employee Turnover', 'Manajemen Sumber Daya Manusia'],

            ['Green Human Resource Management', 'Manajemen Sumber Daya Manusia'],

            ['Green Marketing', 'Manajemen Pemasaran'],

            ['Hubungan Industrial', 'Manajemen Sumber Daya Manusia'],

            ['Inklusi Keuangan dan Keuangan Mikro', 'Manajemen Keuangan'],

            ['Integrasi Vertikal dan Horizontal', 'Manajemen Operasi'],

            ['Islam dan religiusitas dalam', 'Manajemen Sumber Daya Manusia'],

            ['Islam dan religiusitas dalam Manajemen Sumber Daya Manusia', 'Manajemen Sumber Daya Manusia'],

            ['Karyawan Berdasarkan Proyek', 'Manajemen Sumber Daya Manusia'],

...
<div class="content-wrapper" style="min-height: 626.4px;">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Sub Kategori Media
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <ul class="nav nav-tabs mb-3">
        <li class="nav-item">
          <a class="nav-link active" href="sita-master-sub-kategori-media.php"><i class="fas fa-list me-1"></i> Daftar Sub Kategori Media</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="sita-master-sub-kategori-media1.php"><i class="fas fa-list me-1"></i> Daftar Kategori Media</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="sita-master-sub-kategori-media2.php"><i class="fas fa-list me-1"></i> Daftar Media</a>
        </li>
        <li class="nav-item">
                ...
                <table class="table table-bordered table-striped table-sm datatables1">
                  ...
                  <tbody>
                    ...
                    $rows = [
                      ...
                      ['Skripsi','Jurnal','Jurnal Internasional','Terindeks Scopus/WoS','A'],
                      ['Skripsi','Jurnal','Jurnal Internasional','Terindeks EBSCO/DOAJ/Proquest/Copernicus/IEEE','A'],
                      ['Skripsi','Jurnal','Jurnal Internasional','Tidak Terindeks','A-'],
                      ['Skripsi','Jurnal','Jurnal Nasional','Sinta 1','A'],
                      ['Skripsi','Jurnal','Jurnal Nasional','Sinta 2','A'],
                      ['Skripsi','Jurnal','Jurnal Nasional','Sinta 3','A'],
                      ['Skripsi','Jurnal','Jurnal Nasional','Sinta 4','A-'],
                      ['Skripsi','Jurnal','Jurnal Nasional','Sinta 5','A/B'],
                      ['Skripsi','Jurnal','Jurnal Nasional','Sinta 6','A/B'],
                      ['Skripsi','Jurnal','Jurnal Nasional','Tidak Terindeks Sinta','B+'],
                    ...
                    foreach($rows as $r):
                      ...
                      <tr>
                        ...
                        <td class="text-center"><?= htmlspecialchars($r[0]); ?></td>

                        <td class="text-center"><?= htmlspecialchars($r[1]); ?></td>

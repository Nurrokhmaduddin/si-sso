...
<div class="card">
    ...
    <div class="table-responsive">
      ...
      <tbody>
        <tr>
          ...
          <td>4</td>
          <td>
            <button class="btn btn-sm btn-outline-secondary">QR</button>
          </td>
          <td>
  ...
  <td>Indoor</td>
  <td>4</td>
  <td> <button class="btn btn-sm btn-outline-secondary">QR</button></td>
  <td>
    <button class="btn btn-sm btn-outline-primary">✏️</button>
    <button class="btn btn-sm btn-outline-danger">🗑️</button>
  </td>

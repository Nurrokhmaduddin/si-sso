...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Dashboard Stok Bahan (stok saat ini) akumulasi dari stok masuk & keluar
...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    <h5 class="mb-0">📦 Stok Bahan</h5>

    <input type="text" class="form-control form-control-sm w-25" placeholder="Cari bahan...">
  </div>
    ...
    <table class="table table-hover mb-0">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>2.5</td>
          <td>Kg</td>
          <td><span class="badge-stok stok-low">🟡 Low</span></td>
        </tr>
        ...
        <tr>
          ...
          <td>50</td>
          <td>pcs</td>
          <td><span class="badge-stok stok-aman">🟢 Aman</span></td>
        </tr>
        ...
        <tr>
          ...
          <td>0</td>
          <td>Kg</td>
          <td><span class="badge-stok stok-habis">🔴 Habis</span></td>
        </tr>

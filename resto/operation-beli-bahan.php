  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content rounded-3 shadow">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title" id="modalTambahPembelianLabel">Tambah Data Pembelian Bahan</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="alert alert-warning mb-3 py-2" role="alert" style="font-size: 0.9rem;">
            ...
            <strong>Catatan:</strong> Semua field dengan <span class="text-danger">*</span> wajib diisi. Field lainnya akan diisi otomatis oleh sistem.
          </div>
          ...
          <div class="mb-3">
            ...
            <select name="supplier" id="supplier" class="form-select" required>
              ...
              <option value="PT. FreshFood">PT. FreshFood</option>
              <option value="CV. BahanSegar">CV. BahanSegar</option>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="kode_bahan" name="kode_bahan" placeholder="Masukkan Kode Bahan" required>
          </div>
          ...
          <div class="mb-3">
            <label for="qty" class="form-label">Jumlah Pembelian (Qty) <span class="text-danger">*</span></label>
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="total_harga" name="total_harga" placeholder="Terisi otomatis" disabled>
          </div>

          <div class="mb-3">
            <label for="stok_awal" class="form-label">Stok Awal</label>
            <input type="number" class="form-control" id="stok_awal" name="stok_awal" placeholder="Terisi otomatis" disabled>
          </div>

          <div class="mb-3">
            <label for="stok_akhir" class="form-label">Stok Akhir</label>
            <input type="number" class="form-control" id="stok_akhir" name="stok_akhir" placeholder="Terisi otomatis" disabled>
          </div>

          <div class="mb-3">
            <label for="hpp_terbaru" class="form-label">HPP Terbaru (Rp)</label>
            <input type="number" class="form-control" id="hpp_terbaru" name="hpp_terbaru" placeholder="Terisi otomatis" disabled>
          </div>

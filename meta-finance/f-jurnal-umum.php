...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Data Jurnal Umum
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <button 
                        class="btn btn-sm btn-outline-info btn-detail-jurnal"
                        data-tanggal="01/01/2026"
                        data-keterangan="Penerimaan Penjualan Tunai"
                        data-ref="JU-0001"
                        data-user="Admin"
                        data-detail='[
                        {"akun":"Kas","debit":65000000,"kredit":0},
                        {"akun":"Penjualan","debit":0,"kredit":65000000}
                        ]'
                        >
                  ...
                  <tr>
                    ...
                    <td>03/01/2026</td>
                    <td>Penerimaan Penjualan Tunai</td>
                    <td class="text-end text-success">Rp 65.000.000</td>
                    <td class="text-center">
                      <button 
                        class="btn btn-sm btn-outline-info btn-detail-jurnal"
                        data-tanggal="01/01/2026"
                  ...
                  <tr>
                    ...
                    <td>05/01/2026</td>
                    <td>Pembelian Barang Dagang</td>
                    <td class="text-end text-danger">Rp 40.000.000</td>
                    <td class="text-center">
                  ...
                  <tr>
                    ...
                    <td>07/01/2026</td>
                    <td>Pembayaran Hutang Supplier</td>
                    <td class="text-end text-danger">Rp 25.000.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>10/01/2026</td>
                    <td>Penerimaan Piutang Usaha</td>
                    <td class="text-end text-success">Rp 70.000.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="text-end text-danger">Rp 10.000.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="text-end text-success">Rp 100.000.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>18/01/2026</td>
                    <td>Biaya Listrik & Utilitas</td>
                    <td class="text-end text-danger">Rp 3.500.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>20/01/2026</td>
                    <td>Pendapatan Jasa Tambahan</td>
                  ...
                  <tr>
                    ...
                    <td class="text-end text-danger">Rp 20.000.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>25/01/2026</td>
                    <td>Penyesuaian Akhir Periode</td>
                    <td class="text-end">Rp 75.500.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- HEADER INFO -->
        <div class="mb-3">
          <div><b>Ref:</b> <span id="mj-ref"></span></div>
          <div><b>Tanggal:</b> <span id="mj-tanggal"></span></div>
          <div><b>Keterangan:</b> <span id="mj-keterangan"></span></div>
          <div><b>User:</b> <span id="mj-user"></span></div>
        </div>
...
<script>
document.querySelectorAll('.btn-detail-jurnal').forEach(btn => {
  btn.addEventListener('click', function () {
    ...
    // isi header modal
    document.getElementById('mj-tanggal').innerText = tanggal;
    document.getElementById('mj-keterangan').innerText = keterangan;
    document.getElementById('mj-ref').innerText = ref;
    document.getElementById('mj-user').innerText = user;
    ...
    detail.forEach(row => {
      html += `
        <tr>
          ...
          <td class="text-end">${row.kredit.toLocaleString()}</td>
        </tr>
      `;
    });

    document.getElementById('mj-body').innerHTML = html;

    // buka modal
    new bootstrap.Modal(document.getElementById('modalDetailJurnal')).show();
  });
});
</script>
...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Data Jurnal Penyesuaian
        ...
        <div class="card">
          <div class="card-body">
            <div class="table-responsive">
              ...
              <!--
                STYLE:
                - Fokus akuntansi period-end adjustment
                - Menampilkan jurnal koreksi sebelum closing
                - Cocok untuk ERP / accounting system
                - Warning = adjustment impact
                - Info = accrual / prepayment
              -->
              ...
              <table class="table table-bordered table-striped table-sm datatables1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Penyesuaian Persediaan Akhir Bulan</td>
                    <td>Persediaan Barang Dagang</td>
                    <td class="text-end text-warning">Rp 2.500.000</td>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Accrual Gaji Karyawan</td>
                    <td>Beban Gaji</td>
                    <td class="text-end text-danger">Rp 8.000.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Penyusutan Peralatan Kantor</td>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Beban Sewa Dibayar Dimuka</td>
                    <td>Sewa Dibayar Dimuka</td>
                    <td class="text-end text-warning">Rp 3.000.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Penyesuaian Pendapatan Diterima Dimuka</td>
                    <td>Pendapatan Diterima Dimuka</td>
                    <td class="text-end text-info">Rp 5.500.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Penyesuaian Beban Listrik Terutang</td>
                    <td>Beban Listrik</td>
                    <td class="text-end text-danger">Rp 750.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Penyesuaian Piutang Usaha Tak Tertagih</td>
                    <td>Cadangan Piutang</td>
                    <td class="text-end text-danger">Rp 1.000.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Penyesuaian Beban Asuransi</td>
                    <td>Asuransi Dibayar Dimuka</td>
                    <td class="text-end text-warning">Rp 2.200.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Penyesuaian Pendapatan Akrual</td>
                    <td>Piutang Pendapatan</td>
                    <td class="text-end text-success">Rp 4.000.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Penyesuaian Beban Transportasi</td>
                    <td>Beban Transportasi</td>
                    <td class="text-end text-danger">Rp 1.300.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Penyesuaian HPP Persediaan</td>
                    <td>Harga Pokok Penjualan</td>
                    <td class="text-end text-danger">Rp 6.800.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>31/01/2026</td>
                    <td>Koreksi Selisih Stok Opname</td>
                    <td>Persediaan Barang</td>
                    <td class="text-end text-warning">Rp 900.000</td>
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></button>
                    </td>
                  </tr>

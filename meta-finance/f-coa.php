...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Data Akun (Chart of Account)
      ...
      <table class="table table-bordered table-striped table-sm datatables1">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>101</td>
            <td>Kas</td>
            <td>Saldo kas operasional perusahaan</td>
          ...
          <tr>
            ...
            <td>102</td>
            <td>Bank</td>
            <td>Saldo rekening bank perusahaan</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>103</td>
            <td>Piutang Usaha</td>
            <td>Piutang dari pelanggan atas penjualan kredit</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>Stok barang untuk dijual kembali</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>Peralatan operasional kantor</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>201</td>
            <td>Hutang Usaha</td>
            <td>Kewajiban kepada supplier</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>202</td>
            <td>Hutang Bank</td>
            <td>Pinjaman jangka panjang dari bank</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>301</td>
            <td>Modal Pemilik</td>
            <td>Modal awal pemilik perusahaan</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>Pendapatan dari penjualan produk dagang</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>Biaya operasional harian perusahaan</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>Pinjaman perusahaan kepada karyawan</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>Pembayaran di muka kepada supplier</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>Barang titipan dari supplier</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>Mobil operasional perusahaan</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>Akumulasi depresiasi aset tetap</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>204</td>
            <td>Hutang Gaji</td>
            <td>Gaji karyawan yang belum dibayar</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>302</td>
            <td>Laba Ditahan</td>
            <td>Akumulasi laba yang tidak dibagikan</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>Potongan harga yang diberikan ke pelanggan</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>
          ...
          <tr>
            ...
            <td>502</td>
            <td>Beban Listrik</td>
            <td>Biaya listrik operasional kantor</td>
            <td class="text-center">
              <button class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></button>
              <button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button>
            </td>

...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Data Mata Anggaran
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <!-- ========== CARD : Tabel  Granular ========== -->
        <!-- ===================================================== -->
        <!-- TABLE : MATA ANGGARAN (BUDGET MASTER DATA) -->
        <!-- ===================================================== -->
              ...
              <table class="table table-bordered table-striped table-sm datatables1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>BG-011</td>
                    <td>Cadangan Risiko Operasional</td>
                    <td>CONTINGENCY</td>
                    <td>FINANCE</td>
                    <td>Rp 40.000.000</td>
                    <td><span class="badge bg-warning text-dark">Hold</span></td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <!-- INFO CONTEXT (ERP DESIGN NOTE) -->
            <!-- 
              Halaman ini adalah MASTER DATA MATA ANGGARAN.
              Digunakan sebagai referensi utama untuk modul Budgeting & Planning.
              Tidak bersifat transaksi, tetapi master structure untuk control biaya.
            -->

            <div class="alert alert-info mb-3">
              <b>Info:</b> Data ini digunakan sebagai dasar perencanaan & kontrol budgeting perusahaan.
            </div>

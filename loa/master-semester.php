                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#modalHapusTahun">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="modalTambahDataLabel">
          <i class="fas fa-plus-circle me-2 text-primary"></i>Tambah Data
        </h5>

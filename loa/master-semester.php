...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Semester Akademik 
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-center">
                      <button class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modalEditTahun">
                        <i class="fas fa-edit"></i>
                      </button>
                      <button class="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#modalHapusTahun">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="modalTambahDataLabel">
          <i class="fas fa-plus-circle mr-2 text-primary"></i>Tambah Data
        </h5>

      ...
      <!-- ========== CARD 3: Tabel saja ========== -->
        ...
        <tbody>
                ...
                <td align="center">
                  2                </td>
                <td align="center">
                  <a href="perkuliahan-soal-ujian-detail.php">
                    <button type="button" class="btn btn-sm btn-outline-info"><i class="fas fa-edit"></i> Soal Ujian</button>
                  </a>
                </td>
              </tr>
                        <tr>
                ...
                <td align="center">
                  2                </td>
                <td align="center">
                  <a href="https://tsipil-loa.tmidev.my.id/loa/soal_ujian/soal_ujian_data/VVU4MGREUlpNVlR5dEdrNU56SWQzYzBtZjkwMDAxMA">
                    <button type="button" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Soal Ujian</button>
                  </a>
                </td>
              </tr>
                        <tr>
                ...
                <td align="center">
                  4                </td>
                <td align="center">
                  <a href="https://tsipil-loa.tmidev.my.id/loa/soal_ujian/soal_ujian_data/V1dZMFNEUkVNbUFKckNjNGRUSWQzYzBtRHkwMDAxMA">
                    <button type="button" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Soal Ujian</button>
                  </a>
                </td>
              </tr>
                ...
                <td align="center">
                  2                </td>
                <td align="center">
                  <a href="https://tsipil-loa.tmidev.my.id/loa/soal_ujian/soal_ujian_data/TTFJMGVUUlNOR1gzWjdveU9USWQzYzBtOWEwMDAxMA">
                    <button type="button" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Soal Ujian</button>
                  </a>
                </td>
              </tr>
                ...
                <td align="center">
                  3                </td>
                <td align="center">
                  <a href="https://tsipil-loa.tmidev.my.id/loa/soal_ujian/soal_ujian_data/VFZCM05FODBzdGx3eVVEVllNa2d6TFkwMDAwOA">
                    <button type="button" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Soal Ujian</button>
                  </a>
                </td>
              </tr>
                ...
                <td align="center">
                  2                </td>
                <td align="center">
                  <a href="https://tsipil-loa.tmidev.my.id/loa/soal_ujian/soal_ujian_data/UjIwMFp6VllNRUd5cHg0eFdUSWQzYzBtRm4wMDAxMA">
                    <button type="button" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Soal Ujian</button>
                  </a>
                </td>
              </tr>
                ...
                <td align="center">
                  3                </td>
                <td align="center">
                  <a href="https://tsipil-loa.tmidev.my.id/loa/soal_ujian/soal_ujian_data/YjJadE5HVXpwNWU0Zk1EQldOR3N6ZGwwMDAwOA">
                    <button type="button" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Soal Ujian</button>
                  </a>
                </td>
              </tr>
                ...
                <td align="center">
                  3                </td>
                <td align="center">
                  <a href="https://tsipil-loa.tmidev.my.id/loa/soal_ujian/soal_ujian_data/V0RCVE5Hc3ptd0RDcGVUUk9PSEF6cXkwMDAwOA">
                    <button type="button" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Soal Ujian</button>
                  </a>
                </td>
              </tr>
                ...
                <td align="center">
                  2                </td>
                <td align="center">
                  <a href="https://tsipil-loa.tmidev.my.id/loa/soal_ujian/soal_ujian_data/VkUwMFRqUnBNVDZsTkZBelVUSWQzYzBtTGswMDAxMA">
                    <button type="button" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Soal Ujian</button>
                  </a>
                </td>
              </tr>
                ...
                <td align="center">
                  2                </td>
                <td align="center">
                  <a href="https://tsipil-loa.tmidev.my.id/loa/soal_ujian/soal_ujian_data/ZWxjMGREUXlORTRoYncwNGFqSWQzYzBtRzMwMDAxMA">
                    <button type="button" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Soal Ujian</button>
                  </a>
                </td>
              </tr>
                ...
                <td align="center">
                  4                </td>
                <td align="center">
                  <a href="https://tsipil-loa.tmidev.my.id/loa/soal_ujian/soal_ujian_data/ZHpVMFdEUkNOendVaXhFeGVqSWQzYzBtdGEwMDAxMA">
                    <button type="button" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Soal Ujian</button>
                  </a>
                </td>
              </tr>

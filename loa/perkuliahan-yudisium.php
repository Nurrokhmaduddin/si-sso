               ...
               <table class="table table1 table-bordered table-striped table-sm datatables1">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Tidak Aktif</td>
                      <td>
                        <button class="btn btn-sm btn-outline-info" onclick="window.location.href='perkuliahan-yudisium-detail.php'">📄Mahasiswa</button>
                    ...
                    <tr>
                      ...
                      <td>2024</td>
                      <td>2</td>
                      <td>02 Oktober 2024</td>
                      <td>24 Oktober 2024</td>
                      <td>Tidak Aktif</td>
                      <td>
                        <button class="btn btn-sm btn-outline-info" onclick="window.location.href='#'">📄Mahasiswa</button>
                        <button class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modalEditAkun">✏️</button>
                        <button class="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#modalHapusAkun">🗑️</button>
                      </td>
                    </tr>

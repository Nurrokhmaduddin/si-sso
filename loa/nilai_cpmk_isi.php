...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Nilai CPMK Daftar Mahasiswa Kelas Perkuliahan 
						...
						<div class="col-md-4">
							<div class="card card-body cursor card-status-nilai" onclick="pilih_status('all')">
								<center class="text-info">
									<h3><b id="jumlah_semua_mahasiswa"><i class="fas fa-spinner fa-pulse"></i></b></h3>
									<h5><b><i class="fas fa-users"></i> Semua Mahasiswa</b></h5>
								</center>
							</div>
						</div>
						<div class="col-md-4">
							<div class="card card-body cursor card-status-nilai" onclick="pilih_status('1')">
								<center class="text-success">
									<h3><b id="jumlah_sudah_dinilai"><i class="fas fa-spinner fa-pulse"></i></b></h3>
						...
						<div class="col-md-4">
							<div class="card card-body cursor card-status-nilai" onclick="pilih_status('2')">
								<center class="text-danger">
									<h3><b id="jumlah_belum_dinilai"><i class="fas fa-spinner fa-pulse"></i></b></h3>

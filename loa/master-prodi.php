               ...
               <table class="table table1 table-bordered table-striped table-sm datatables1">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>S-1</td>                    
                    <td>Program Sarjana Informatika</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>S-2</td>
                    <td>Program Magister Informatika</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>S-3</td>
                    <td>Program Doktoral Informatika</td>
                    <td>
...
<div class="modal fade" id="modalBantuan" tabindex="-1" aria-labelledby="modalBantuanLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
         Prodi = unit resmi pendidikan di kampus yang memiliki kurikulum tertentu dan menghasilkan gelar tertentu. Namun, LOA ini di disarankan khusus untuk digunakan pada level Prodi, bukan level departemen
        </p>
      </div>
      <div class="modal-footer">

...
<!-- ========== CARD : Filter & Export ========== -->
         ...
         <!-- TAB NAV  -->
           <ul class="nav nav-tabs">
            <li class="nav-item" onclick="window.location='evaluasi-kemajuan.php'"><a class="nav-link active">Temuan Evaluasi</a></li>
            <li class="nav-item" onclick="window.location='evaluasi-kemajuan2.php'"><a class="nav-link ">Aksi Evaluasi</a></li>
          </ul>

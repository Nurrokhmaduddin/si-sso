...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <ul class="nav nav-tabs">   
    ...
    <li class="nav-item" onclick="window.location='perkuliahan-yudisium-detail2.php'"><a class="nav-link ">Hasil Yudisium</a>
    <li class="nav-item" onclick="window.location='perkuliahan-yudisium-detail3.php'"><a class="nav-link active">Joined</a></li>
  </ul>
<!-- ========== CARD 3: Tabel saja ========== -->
          <div class="card">
...
<tr>
    ...
    <td><span class="badge badge-success">Memenuhi</span></td>
...
<tr>
    ...
    <td><span class="badge badge-warning">Belum Memenuhi</span></td>
...
<tr>
    ...
    <td><span class="badge badge-success">Lengkap</span></td>
    <td><span class="badge badge-danger">Belum Memenuhi</span></td>

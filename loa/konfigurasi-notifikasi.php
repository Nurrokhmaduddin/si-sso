          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <tbody>
                ...
                <tr>
                  <td>1</td>
                  <td>Reminder untuk upload RPS</td>
                  <td>Perkuliahan - RPS</td>
                  <td>
                    <a href="konfigurasi-notifikasi-detail.php" 
...
<tr>
                  <td>2</td>
                  <td>Reminder untuk upload Soal Ujian</td>
                  <td>Perkuliahan - Soal Ujian</td>
                  <td>
                    <a href="konfigurasi-notifikasi-detail2.php" 
                    class="btn btn-sm btn-outline-primary">
                    <i class="fas fa-edit"></i></a>
                  </td>
                </tr>

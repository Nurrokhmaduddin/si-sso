...
kok masih gagal ya, tombol modalnya. filter, add, import.
<!DOCTYPE html>
<html lang="id">
<head>
  <meta charset="UTF-8">
...
<footer class="main-footer" style="font-size: 10pt; background-color: #e5eaf0;">
  <center>
    <font color="#000000">
      SSO V 4.0 | Copyright © 
      PT Tanjung Mulia Informatika     <br>
...
$(document).ready(function() {
    $('.datatables1').DataTable({
        "pageLength": 10,
        "lengthChange": true,  // aktifkan dropdown jumlah entri
        "autoWidth": false,
        "order": [[ 0, "desc" ]] // urut berdasarkan created_at. 0 adalah kolom pertama, 6 adalah kolom ketujuh.
    });
});
//membuat fitur filer berdasarkan kolom masing2

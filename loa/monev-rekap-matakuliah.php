...
<!-- ========== CARD 4: Chart CPMK Min/Max/Rerata/%Tuntas ========== -->
          <div class="card">
            ...
            <div class="card-body chart-container">
              <canvas id="chartDaftarMK" ></canvas>              
            </div>            
          </div>
              ...
              <table class="table table1 table-bordered table-striped table-sm datatables1">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>3</td>
                    <td class="text-center">
                      <button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modalDetailMK">
                        📄 Detail
                      </button>
                    </td>
                  </tr>
...
'BIM untuk Manajemen Konstruksi',
'Water Structures Design'
];

const ctxm = document.getElementById('chartDaftarMK').getContext('2d');
...
new Chart(ctxm, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [90, 90, 140, 140, 140, 70, 50, 4, 140, 140],
            backgroundColor: "rgba(255, 99, 132, 0.7)",
            borderColor: "rgb(255, 99, 132)",
            borderWidth: 1
        }]
            ...
            tooltip: {
                callbacks: {
                    label: function(context) {
                        ...
                        let kode = context.label;
                        let nama = namaMK[index];
                        let jumlah = context.raw;

                        return kode + ' - ' + nama + ': ' + jumlah + ' mahasiswa';

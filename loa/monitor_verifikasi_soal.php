<?php $page = 'monitor_verifikasi_soal'; ?>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <p class="text-muted mb-0">
      Admin.Monitoring proses upload, revisi, verifikasi, dan persetujuan soal ujian oleh dosen dan verifikator.
    </p>
...
<!--     <div class="row">
      ...
      <div class="col-md-2">
        <div class="card">
          <div class="card-body">
            <small>Kelas Belum Upload</small>
            <h3 class="mb-0 text-danger">30</h3>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-2">
        <div class="card">
          <div class="card-body">
            <small>Penugasan Validator</small>
            <h3 class="mb-0 text-warning">98</h3>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-2">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="mb-0 text-success">71</h3>
          </div>
        </div>
      </div>
  ...
  <div class="card">
    ...
    <div class="card-header d-flex align-items-center">
      ...
      <h5 class="card-title mb-0">
        Daftar Monitoring Verifikasi Soal
      </h5>

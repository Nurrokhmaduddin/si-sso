...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Daftar Capaian Pembelajaran Lulusan 
              ...
              <table class="table table1 table-bordered table-striped table-sm datatables1">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>CPL 1</td>
                      <td>Bertakwa kepada Tuhan Yang Maha Esa dan berperilaku islami (jujur, disiplin, tanggung jawab, dan kerja cerdas) pada setiap peran yang dijalani, baik di industri kimia maupun masyarakat umum</td>
                    ...
                    <tr>
                      ...
                      <td class="text-center">K25 full stage</td>
                      <td>CPL 2</td>
                      <td>Kemampuan untuk menginternalisasi semangat kemandirian dan Kewirausahaan</td>
                      <td class="text-center">
                        <button type="button" class="btn btn-sm btn-outline-warning">🔑</button>
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modalEditAkun">✏️</button>
                        <button type="button" class="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#modalHapusAkun">🗑️</button>
                    ...
                    <tr>
                      ...
                      <td class="text-center">K25 full stage</td>
                      <td>CPL 3</td>
                      <td>Kemampuan untuk bertanggung jawab kepada masyarakat dan mematuhi etika profesi dalam menyelesaikan permasalahan teknik kimia</td>  
                      <td class="text-center">
                        <button type="button" class="btn btn-sm btn-outline-warning">🔑</button>
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modalEditAkun">✏️</button>
                        <button type="button" class="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#modalHapusAkun">🗑️</button>
                    ...
                    <tr>
                      ...
                      <td class="text-center">K25 full stage</td>
                      <td>CPL 4</td>
                      <td>Kemampuan berkomunikasi secara efektif baik lisan maupun tulisan</td>   
                      <td class="text-center">
                        <button type="button" class="btn btn-sm btn-outline-warning">🔑</button>
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modalEditAkun">✏️</button>
                        <button type="button" class="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#modalHapusAkun">🗑️</button>
                    ...
                    <tr>
                      ...
                      <td class="text-center">K25 full stage</td>
                      <td>CPL 6</td>
                      <td>Kemampuan bekerja dalam tim lintas disiplin dan lintas budaya</td>
                      <td class="text-center">
                        <button type="button" class="btn btn-sm btn-outline-warning">🔑</button>
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modalEditAkun">✏️</button>
                        <button type="button" class="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#modalHapusAkun">🗑️</button>

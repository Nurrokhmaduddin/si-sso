    ...
    <div class="card-body">
         <table class="table table-hover table-bordered table-sm datatables1">
            ...
            <tbody>
                ...
                <tr><td>4</td><td>STS101</td><td>STS101-1</td><td>69</td><td>70%</td><td>40</td><td class="tidak">Tidak Memenuhi</td></tr>
                <tr><td>5</td><td>STS101</td><td>STS101-2</td><td>84</td><td>90%</td><td>40</td><td class="memenuhi">Memenuhi</td></tr>
                <tr><td>6</td><td>STS101</td><td>STS101-3</td><td>76</td><td>82%</td><td>40</td><td class="memenuhi">Memenuhi</td></tr>
                <tr><td>7</td><td>STS101</td><td>STS101-4</td><td>74</td><td>78%</td><td>40</td><td class="tidak">Tidak Memenuhi</td></tr>
        ...
        <!-- ========== CARD 4: Chart CPMK Min/Max/Rerata ========== -->
        <div class="card">
          <div class="card-header">
          ...
          <div class="card-body chart-container">
            ...
            <div class="row text-center mt-3">
              ...
              <div class="col">
                <button class="btn btn-outline-info btn-sm w-100" data-toggle="collapse" data-target="#daftarIKCPL32">
                  Rangking Mahasiswa
                </button>
              </div>
              <!-- <div class="col">
              ...
              <div class="col">
                <button class="btn btn-outline-danger  btn-sm w-100" data-toggle="collapse" onclick="openAllStudentsPreview()">
                  Mahasiswa Risiko
                </button>
              </div>
            </div>

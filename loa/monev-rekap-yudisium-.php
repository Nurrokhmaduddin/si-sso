  ...
  <div class="card-body">
    <table class="table table-bordered table-striped table-sm ">
      ...
      <tbody>
        ...
        <tr class="bg-info">
          <td class="bg-info">Periode Jan 2027</td>
          <td class="bg-info">60</td>
          <td class="bg-info">65</td>
          <td class="bg-info">68</td>
          <td class="bg-info">70</td>
          <td class="bg-info">72</td>
          <td class="bg-info">75</td>
          <td class="bg-info">77</td>
          <td class="bg-info">79</td>
          <td class="bg-info">80</td>
          <td class="bg-info">74</td>
        </tr>
      </tbody>
      <tfoot>
        <tr>
          <td colspan="11">
            ...
            - Tabel menampilkan perbandingan capaian rata-rata tiap CPL pada 3 batch yudisium.<br>
...
<div class="modal fade" id="modalBantuan" tabindex="-1" aria-labelledby="modalBantuanLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          MONEV YUDISIUM (Final Outcome)

(Level Outcome Lulusan)

🎯 3 Pertanyaan Analisis

Apakah lulusan memenuhi standar profil lulusan?

Apakah IPK mencerminkan capaian CPL?

Apakah ada tren penurunan mutu lulusan?

🚨 3 EWS
EWS 1 – IPK turun 2 periode berturut
EWS 2 – Rata-rata masa studi naik
EWS 3 – CPL akhir < target
⚠ Temuan Kritis

IPK rata-rata naik, tapi CPL komunikasi rendah.

Artinya:

Nilai akademik tinggi

Kompetensi soft skill lemah

Tindak lanjut:

Tambah presentasi / project
        </p>
        <p>
...
Fokusnya kualitas akhir dan konsistensinya.
        </p>
        ...
        <p>
          snapshot CPL by batch yudisium adalah gambaran CPL Mahasiswa yang lulus pada satu periode  yudisium tertentu tanpa memandang tahun masuknya(bisa campuran angkatan dan bahkan kurikulum), sehingga tujuannya adalah memonitor mutu output lulusan terkini; informmasi yag perlu disajikan meliputi jumlah lulusan periode tersebut, distribusi angkatan masuk, IPK rerata dan distribusinya, lama studi rerata rerata CPL dan distribusinya, persentasi remedial tinggi (misal >3 MK) remidial. dan perbandingan dengan batch yudisium sebelumnya untuk melihat stabilitas output periodik. singkatnya  snapshot batch yudisium menjawab " bagaimana mutu lulusan yang keluar pada periode ini?"
          untuk mutu lulusan.
        </p>
...
new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [
      ...
      // },
      {
        label: '% Mahasiswa Tuntas CPL',
        data: [95, 80, 60, 88, 92, 85, 98, 83, 75, 58],

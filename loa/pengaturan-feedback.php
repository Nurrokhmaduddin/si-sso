        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <!-- <div class="card-header">
              <h5 class="card-title mb-0"><i class="fas fa-filter "></i> Judul Tabel yang terdampak tombol aksi ini<button type="button" class="btn btn-tool" data-toggle="modal" data-target="#modalBantuan" title="Bantuan">
            ...
            <div class="card-body ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <b>Rentang Tanggal:</b> 11 Mar 2026 - 12 Mar 2026 &nbsp;
                </div> 
                <div class="col-md-6">
                  <b>Periode Tanggal:</b> Mar 2026 &nbsp;
                </div> 
                 <div class="col-md-6">
                  <b>Kategori:</b> Semua
                </div>  
...
<div class="row ">
  ...
  <div class="col-md-2">
    <div class="card text-center border-info">
      <div class="card-body">
        <h6 class="text-muted">Ditinjau</h6>
      ...
      <table class="table table-bordered table-striped table-sm datatables1">
        <thead>
          <tr>
            ...
            <th title="VARCHAR(150) • Login username">Tanggal</th>
            <th title="VARCHAR(255) • Email unik">Pengguna</th>
            <th title="VARCHAR(255) • Nama utuh">Kategori</th>
            <th title="VARCHAR(255) • Hashed password">Isi pesan</th>
            <th title="BOOLEAN • Account aktif?">Status</th>
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped table-sm datatables1">
        <thead>
          <tr>
            <th title="BIGINT • Primary key">Id</th>
            <th title="BIGINT • Primary key">Kategori/Periode</th>
            <th style="width: 80px;">Jan 2026</th>
            <th style="width: 80px;">Feb 2026</th>
            <th style="width: 80px;">Mar 2026</th>
            <th style="width: 80px;">Apr 2026</th>
            <th style="width: 80px;">Mei 2026</th>
            <th style="width: 80px;">Jun 2026</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td>101</td>
            <td>Bug Sistem</td>
            <td>23</td><td>23</td><td>23</td><td>23</td><td>23</td><td>23</td>
          </tr>
          <tr>
            <td>102</td>
            <td>Usulan Fitur</td>
            <td>17</td><td>17</td><td>17</td><td>17</td><td>17</td><td>17</td>
          </tr>
          <tr>
            <td>103</td>
            <td>Perbaikan Tampilan</td>
            <td>4</td><td>4</td><td>4</td><td>4</td><td>4</td><td>4</td>
          </tr>
          <tr>
            <td>104</td>
            <td>Kesulitan Penggunaan</td>
            <td>4</td><td>4</td><td>4</td><td>4</td><td>4</td><td>4</td>
          </tr>
          <tr>
            <td>105</td>
        ...
        <tfoot>
          <tr>
            <td></td>
            <td>Total</td>
            <td>48</td><td>48</td><td>48</td><td>48</td><td>48</td><td>48</td>
          </tr>
        </tfoot>
      </table>
    </div>
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped table-sm datatables1">
        <thead>
          <tr>
            <th title="BIGINT • Primary key">id</th>
            <th title="VARCHAR(150) • Login username">Kategori</th>
            <th >aksi</th>
          </tr>
        </thead>
        <tbody>

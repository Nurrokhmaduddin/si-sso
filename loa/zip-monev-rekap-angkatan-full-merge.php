<?php
// File hasil merge dari monev-rekap-angkatan-.php dan monev-rekap-angkatan-backup.php
 $page = 'monev_angkatan'; ?>
...
<!-- MERGED: Tabel ringkasan skor CPL dari file utama -->
<div class="card mt-3">
  <div class="card-body">
...
<!-- MERGED: Grafik tambahan dari file utama -->
<div class="card mt-3">
  <div class="card-header">
    <h3 class="card-title">Grafik Radar CPL dan Rerata CPL</h3>
  </div>
  <div class="card-body">
    <div class="row">
      <div class="col-lg-6">
...
<!-- MERGED: Script radarCPL dan chartCPL3 dari file utama -->
<script>
  // ----- Radar CPL -----
 ...
 * FULL SOURCE ARCHIVE
 * -------------------
 * The two complete original files are retained below as nowdoc strings.
 * This intentionally preserves commented and uncommented code exactly.
 * The archive is not rendered or executed; the functional merged page is above.
 */
$SOURCE_MAIN_ORIGINAL = <<<'SOURCE_MAIN_ORIGINAL'
...
<?php include('5script.php'); ?>
SOURCE_MAIN_ORIGINAL;
$SOURCE_BACKUP_ORIGINAL = <<<'SOURCE_BACKUP_ORIGINAL'
<?php $page = 'monev_angkatan'; ?>
<?php include('1header.php'); ?>
<?php include('2navbar.php'); ?>
<?php include('3sidebar.php'); ?>

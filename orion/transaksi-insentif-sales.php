...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <ul class="nav nav-tabs">   
    <li class="nav-item" onclick="window.location='transaksi-insentif-sales.php'"><a class="nav-link active">Pemberian</a></li>
    <li class="nav-item" onclick="window.location='transaksi-insentif-sales1.php'"><a class="nav-link ">Insentif</a></li>
  </ul>
      ...
      <table class="table table-bordered table-striped table-sm datatables1">
        ...
        <tbody>
          <tr align="center">
            ...
            <td align="center">
              <div class="btn-group">
                <button type="button" class="btn btn-success btn-sm btn-aksi4" data-toggle="dropdown" fdprocessedid="58jb89">
                  <span class="sr-only">Toggle Dropdown</span><i class="fas fa-print"></i>
                </button>
                <div class="dropdown-menu" role="menu">
                  <a class="dropdown-item" href="https://orion-houseware.my.id/insentif_sales/print_insentif/VXpVME1UazFraklkM2MwbTRLMDAwMDY" target="_blank">PDF</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="https://orion-houseware.my.id/insentif_sales/ekspor/UVd0d1RlYjFvTkRBemJNMDAwMDQ" target="_blank">Excel</a>
                </div>
              </div>
              <button type="button" class="btn btn-info mrg-btn btn-sm btn-aksi4 btn-disabled" title="Detail" onclick="detail(&#39;UTI1WGNvNDRWTkhBemg4MDAwMDQ&#39;, &#39;4&#39;)" fdprocessedid="ga97yl"><i class="fas fa-list"></i></button>
            </td>
          </tr>
          <tr align="center">
            <td>2</td>

...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0"> Detail Faktur
        <button type="button" class="btn btn-tool" data-bs-toggle="modal" data-bs-target="#modalBantuan" title="Bantuan"><i class="fas fa-question-circle"></i>
        </button>
      </h3>
        <p class="text-muted mb-0">Order Tracking =  order yang masih Dalam tahap Proses</p>
    </div>
  </section>
...
<div class=" col-6">
    ...
    <h5>Faktur</h5>
    <p>No Faktur: INV-001</p>
    <p>Tanggal: 12 Jan 2026</p>
    <p>Status: Dikirim</p>
             ...
             <div class="card-footer">
              <div class="card-tools ms-auto">
                <button class="btn btn-outline-secondary btn-sm " onclick="window.location='transaksi-tracking-order-detail.php<?=$q;?>'">

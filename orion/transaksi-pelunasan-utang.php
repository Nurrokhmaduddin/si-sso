...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <ul class="nav nav-tabs">   
    <li class="nav-item" onclick="window.location='transaksi-pelunasan-utang.php'"><a class="nav-link active">Pelunasan</a></li>
    <li class="nav-item" onclick="window.location='transaksi-pelunasan-utang1.php'"><a class="nav-link ">History</a></li>
  </ul>
      ...
      <table class="table table-bordered table-striped table-sm datatables1">
        <thead>
          <tr align="center">
            ...
            <th>Nominal Terbayar (Rp)</th>
            <th>Utang Dagang (Rp)</th>
            <th>Aksi</th>
          </tr>
        </thead>
        <tbody>

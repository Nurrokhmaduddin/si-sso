...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <ul class="nav nav-tabs">   
    <li class="nav-item" onclick="window.location='transaksi-insentif-sales.php'"><a class="nav-link ">Pemberian</a></li>
    <li class="nav-item" onclick="window.location='transaksi-insentif-sales1.php'"><a class="nav-link active">Insentif</a></li>
  </ul>

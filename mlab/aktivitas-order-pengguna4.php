...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid"> 
      <h3 class="mb-0">Formulir Pembuatan Order <small>00421124</small>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="row">
                  ...
                  <table class="table table-sm table-bordered table-striped">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>oke</td>
                        <td>
                          <a title="Edit baris" class="btn btn-xs btn-info"><i class="fas fa-edit"></i></a>
                  ...
                  <table class="table table-sm table-bordered table-striped mb-10">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td id="id_kesimpulan_7060"></td>
                      </tr>
                      <tr>
                        <td>2</td>
                        <td>Core drill rigid pavement 5 titik</td>
                        <td>
                          <input type="checkbox" class="chk-new">
                        </td>
                        <td>
                          <i class="fa fa-check"></i>
                        </td>
                  ...
                  <table class="table table-sm table-bordered table-striped mb-10">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td colspan="2" class="text-right" id="id_tanggal_selesai">27-Mar-2026</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <div class="col-md-12">
<button class="btn btn-primary btn-block" data-bs-toggle="modal" data-bs-target="#modalKonfirmasiOrder">Konfimasi Tender Kontrak</button>
</div>
          <!-- <div class="col-md-12">
            <div class="callout callout-info">
              <p>Untuk menyatakan persetujuan atau pembatalan Tender Kontrak di atas, klik tombol berikut:</p>
              <a class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#modalKonfirmasiOrder"
                > Setujui Order</a>
                <a class="btn btn-danger" href="#" data-bs-toggle="modal" data-bs-target="#modalKonfirmasiOrder"
                > Batalkan Order</a>
            </div>
          </div> -->
           <!-- <div class="col-md-12">
              <div class="callout callout-info">
              <p>Tender Kontrak Order <b>DISETUJUI</b> pada tanggal: 07-Mar-2026</p>
            </div>
          </div> -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">   
        ...
        <a href="data-formulir-order.xlsx" class="btn btn-sm btn-outline-success w-100">Download Template</a>
      </div>
...
<!-- MODAL KONFIRMASI -->
<div class="modal fade" id="modalKonfirmasiOrder" tabindex="-1">
...
Untuk menyatakan persetujuan atau pembatalan Tender Kontrak di atas, klik tombol berikut:</p>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location='aktivitas-order-pengguna5.php'">
          Setujui
        </button>

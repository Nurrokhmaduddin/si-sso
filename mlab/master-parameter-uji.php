...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <ul class="nav nav-tabs">   
    <li class="nav-item" onclick="window.location='master-parameter-uji.php'"><a class="nav-link active">Parameter Uji</a></li>
    <li class="nav-item" onclick="window.location='master-parameter-uji2.php'"><a class="nav-link ">Metode Uji</a></li>
      ...
      <table class="table table-bordered table-hover table-sm datatables1">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Uji Aspal Paket</td>
            <td class="text-center">AS-P</td>
            <td>All standard properties</td>
            <td>
              Berat jenis, Penetrasi, Titik Lembek, Titik Nyala dan Titik Bakar,
              Kelarutan pada TCE, Daktilitas, Kelekatan Aspal
            </td>
            <td>-</td>
          ...
          <tr>
            ...
            <td>Berat jenis</td>
            <td>Uji berat jenis sampel aspal</td>
            <td>-</td>
            <td class="text-center">
              <button class="btn btn-sm btn-primary">Edit</button>
            </td>
          ...
          <tr>
            ...
            <td>Uji Aspal</td>
            <td class="text-center">AS-1</td>
            <td>Titik nyala & titik bakar</td>
            <td>Uji titik nyala dan titik bakar sampel aspal</td>
            <td>-</td>
            <td class="text-center">
              <button class="btn btn-sm btn-primary">Edit</button>
            </td>

...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <ul class="nav nav-tabs">   
    <li class="nav-item" onclick="window.location='master-parameter-uji.php'"><a class="nav-link ">Parameter Uji</a></li>
    <li class="nav-item" onclick="window.location='master-parameter-uji2.php'"><a class="nav-link active">Metode Uji</a></li>
    <li class="nav-item" onclick="window.location='master-parameter-uji3.php'"><a class="nav-link ">Standar Pengujian</a></li>
  </ul>
          <!-- ========== CARD : Filter & Export ========== -->
          <div class="card">
            <div class="card-body ">
...
<div class="card shadow-sm">
  ...
  <div class="card-body">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-bordered table-hover table-sm datatables1">
  ...
  <thead>
    <tr>
      ...
      <th>Nama</th>
      <th>Keterangan</th>
      <th>Kapasitas Kerja Instrumen (sampel)</th>
      <th>Jumlah Operator Instrument (orang)</th>
      <th>Durasi waktu kerja (maks 40 jam/pekan)</th>
      <th>Kuota Layanan Pengujian Pekanan (sampel*orang*jam)</th>
      <th>Action</th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td>Lab. GIS & Seismik</td>
      <td>TOP-UP</td>
      <td>Jasa Survey Topografi & Pemetaan > 1000 m2</td>
      <td>Pengukuran Topografi dan Pembuatan Peta lebih dari 1000 m2</td>
      <td class="text-center">1</td>
      <td class="text-center">2</td>
    ...
    <tr>
      ...
      <td>TOP-1</td>
      <td>Jasa Survey Topografi & Pemetaan < 1000 m2</td>
      <td>Pengukuran Topografi dan Pembuatan Peta</td>
      <td class="text-center">1</td>
      <td class="text-center">2</td>
      <td class="text-center">20</td>
      <td class="text-center">40</td>
    ...
    <tr>
      ...
      <td>Lab. Bahan Konstruksi Teknik</td>
      <td>S-BKT1</td>
      <td>Sewa Alat - Cetakan Silinder Beton</td>
      <td>Lapangan</td>
    ...
    <tr>
      ...
      <td>Lab. Bahan Konstruksi Teknik</td>
      <td>L-BKT6</td>
      <td>Profometer - per titik (lebih dari 1 paket)</td>
      <td>Lapangan</td>
      <td class="text-center">100</td>
      <td class="text-center">4</td>
      <td class="text-center">40</td>
    ...
    <tr>
      ...
      <td>Lab. Bahan Konstruksi Teknik</td>
      <td>L-BKT5</td>
      <td>Profometer - 1 Paket 5 titik</td>
      <td>Lapangan</td>
      <td class="text-center">100</td>
      <td class="text-center">4</td>
      <td class="text-center">40</td>
    ...
    <tr>
      ...
      <td>Lab. Bahan Konstruksi Teknik</td>
      <td>L-BKT4</td>
      <td>UPV - per titik (lebih dari 1 paket)</td>
      <td>Lapangan</td>
      <td class="text-center">100</td>
      <td class="text-center">4</td>
      <td class="text-center">40</td>
    ...
    <tr>
      ...
      <td>Lab. Bahan Konstruksi Teknik</td>
      <td>L-BKT2</td>
      <td>Hammer - per titik (lebih dari 1 paket)</td>
      <td>Lapangan</td>
      <td class="text-center">100</td>
      <td class="text-center">4</td>
      <td class="text-center">40</td>

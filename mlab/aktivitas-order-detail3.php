...
<div class="col-md-2">
    <div class="callout callout-success">
        ...
        <a href="https://api.whatsapp.com/send?phone=6287707118691" target="_blank">
            <img src="./aktivitas-order-detail1_files/whatsapp-button.png" alt="" class="img-responsive text-center" width="150px">
        </a>
    </div>
</div>
...
<div class="col-md-12">
            <div class="card card-outline card-info">
                  ...
                  <table class="table table-sm table-bordered table-striped">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>oke</td>
                        <td>
                          <a title="Edit baris" class="btn btn-xs btn-primary"><i class="fas fa-edit"></i></a>
                      ...
                      <tr align="center">
                        <td colspan="8">
                          ...
                          <button class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalTambahData">
                            <i class="fas fa-plus me-1"></i>Tambah (1 sampel)
                          </button>
                        <!-- </div>
                        <div class="col"> -->
                          <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalImpor">
                            <i class="fas fa-file-upload me-1"></i> Import (>1 sampel)
                          </button> 
                          <!-- </div>
                        </div> -->
                        </td>
              ...
              <div class="card-footer " align="right">
                bisa tambahakan order, namun harus 'daftar ulang' agar rekap harga dan lainnya update. sebelum update tender, harus isi tanggal perkiraan dulu. setelah update, ada notif kirim ke pelanggan.
                <a class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#modalKonfirmasiOrder"
                > Daftarkan Detail Order</a>
              </div>
          </div>
      </div>
      ...
      <div class="col-md-12">
                ...
                <table class="table table-sm table-bordered table-striped mb-10">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="checkbox" class="chk-new"></td>
                            <td><input type="checkbox" class="chk-new"></td>
                            <td id="id_kesimpulan_7060"><span class="badge badge-new">⭐ NEW</span>
                                <a class="btn btn-primary btn-xs" title="Isi Biaya" href="https://simlabts.tsipil-uii.ac.id/administrasi-layanan/daftar-order/e84203d3-4713-49f5-8579-ba4130e8ddcf#modalForm" data-toggle="modal" data-href="https://simlabts.tsipil-uii.ac.id/administrasi-layanan/daftar-order/e84203d3-4713-49f5-8579-ba4130e8ddcf/edit-biaya/7063">
                                    Isi Kesimpulan
                                </a></td>
                        </tr>
                        <tr>
        ...
        <div class="card-footer " align="right">
                <button id="btnTandaiDibaca" class="btn btn-outline-primary "><i class="fa fa-check"></i> Default Check</button>
         <a href="javascript:;" data-title="Anda yakin ingin merubah status" data-redirect="https://simlabts.tsipil-uii.ac.id/administrasi-layanan/daftar-order/e84203d3-4713-49f5-8579-ba4130e8ddcf/set-pengkajian" class="btn btn-success  confirm-action"><i class="fa fa-check"></i> Set
         Default</a>
              </div>
 </div>
...
<div class="col-md-12">
                  ...
                  <table class="table table-sm table-bordered table-striped mb-10">
                    ...
                    <tfoot class="table-">
                      <tr align="center">
                        <td colspan="8">
                          <button class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalTambahData">
                            <i class="fas fa-plus me-1"></i>Isi Subkontrak
                          </button>
                        </td>
                      </tr>
                    </tfoot>
            ...
            <div class="card card-outline card-info">
                  ...
                  <table class="table table-sm table-bordered table-striped mb-10">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td colspan="1" class="text-right" id="id_total">4,000,000.00</td>
                        <td colspan="2"></td>
                      </tr>
                      <tr>
                        <td colspan="6" class="text-right">Pekerjaan diperkirakan selesai pada tanggal:</td>
                        <td colspan="1" class="text-right" id="id_tanggal_selesai"></td>
                         <td colspan="2"></td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div class="card-footer" align="right">
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambahData">
                            <i class="fas fa-plus me-1"></i>Isi Tanggal Perkiraan
                          </button>
              </div>
            </div>
          </div>
        ...
        <div class="callout callout-info">
          <p>Tender Kontrak <span class="text-success"><strong>DIUPDATE</strong></span> admin pada tanggal:  11-Nov-2024. Order <span class="text-success"><strong>DISETUJUI</strong> </span> Pemberi Order pada tanggal:  12-Nov-2024</p>
        </div>

          <button class="btn btn-primary btn-block confirm-action mb-2" data-redirect="https://simlabts.tsipil-uii.ac.id/administrasi-layanan/daftar-order/e84203d3-4713-49f5-8579-ba4130e8ddcf/update-order" fdprocessedid="wrlml9">

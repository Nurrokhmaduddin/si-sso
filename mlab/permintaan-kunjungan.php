...
<div class="container-fluid">
  ...
  <div class="row mb-3">
    <div class="col-md-6">
      <h4 class="fw-bold">Tagihan & Pembayaran</h4>
      <small class="text-muted">Manajemen Tagihan Order Laboratorium</small>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <select class="form-select">
            ...
            <option value="lunas">Open</option>
            <option value="terhutang">In Progress</option>
            <option value="uangmuka">On Hold</option>
            <option value="terhutang">Answered</option>
            <option value="uangmuka">Closed</option>
        ...
        <div class="col-md-4">
          ...
          <input type="text" class="form-control" placeholder="Cari nomor order / nama customer">
        </div>
  ...
  <div class="card">
    ...
    <div class="card-header">
      <h5 class="mb-0">Daftar Permintaan Kunjungan</h5>
    </div>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title">Filter Tagihan</h5>

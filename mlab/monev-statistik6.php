...
<div class="row g-3 mb-3">
 ...
 <!-- TAB NAV (Semester) -->
           <ul class="nav nav-tabs">
            ...
            <li class="nav-item" onclick="window.location='monev-statistik6.php'"><a class="nav-link active">Kinerja</a></li>
          </ul>
...
<!--   <div class="card">
  ...
  <div class="card">
    ...
    <div class="card-body">
<button onclick="window.location='monev-kinerja.html'">0</button>
<button onclick="window.location='monev-kinerja1.html'">1</button>
<button onclick="window.location='monev-kinerja2.html'">2</button>
<button onclick="window.location='monev-kinerja3.html'">3</button>
<button onclick="window.location='monev-kinerja4.html'">4</button>
  </div>
</div>

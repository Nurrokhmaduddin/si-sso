...
<div class="row g-3 mb-3">
 ...
 <!-- TAB NAV (Semester) -->
           <ul class="nav nav-tabs">
            ...
            <li class="nav-item" onclick="window.location='monev-statistik1.php'"><a class="nav-link active">Order Instrumentasi</a></li>
...
<!--   <div class="card">
  ...
  <div class="card">
    ...
    <div class="card-body">
<button onclick="window.location='monev-order.html'">0</button>

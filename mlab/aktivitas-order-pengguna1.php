...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid"> 
      <h3 class="mb-0">Formulir Pembuatan Order
        <button type="button" class="btn btn-tool" data-bs-toggle="modal" data-bs-target="#modalBantuan" title="Bantuan"><i class="fas fa-question-circle"></i>
        </button>
        <button class="btn btn-info mb-10" type="button" data-bs-toggle="modal" data-bs-target="#petunjukModal">
            Baca Petunjuk
        </button>
      </h3>
 ...
 <!-- INFORMASI ORDER -->
                      ...
                      <div class="panel panel-default">
                        <div class="panel-body">
                          <table class="table table-sm table-borderless">
                            <tbody><tr>
                              <th width="30%">Nama Pengorder: </th>
                              <td>harun</td>
                            </tr>
                            <tr>
                              <th>E-mail: </th>
                              <td>harunruddin54@gmail.com</td>
                            </tr>
                            <tr>
                              <th>Nomor HP: </th>
                              <td>
                                <a target="_blank" href="https://api.whatsapp.com/send?phone=085640536509">085640536509</a>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <th>Alamat: </th>
                              <td>Jl. Kaliurang km 14.5, Sleman, Yogyakarta</td>
                            </tr>
                            <tr>
                              <th>Provinsi: </th>
                              <td>DI YOGYAKARTA</td>
                  ...
                  <div class="col-md-6">
                    <div class="form-group ">
                      ...
                      <input class="form-control" name="nama_proyek" type="text" id="nama_proyek">
                    </div>
                    <div class="form-group ">
                      <label for="owner_proyek">Owner Proyek:</label>
                      <input class="form-control" name="owner_proyek" type="text" id="owner_proyek">
                    </div>
                    <div class="form-group  ">
                      <label for="atas_nama" class="control-label">Sertifikat Hasil Uji diatasnamakan:</label>
                      <div class="input-group ">
                        <span class="input-group-addon">
                          <input name="r_atas_nama" type="radio" value="Pemberi Order">
                        </span>
                        <input type="text" class="form-control" placeholder="Pemberi Order" disabled="">
                      </div>
                      <div class="input-group">
                        <span class="input-group-addon">
                          <input name="r_atas_nama" type="radio" value="Pihak Lainnya">
                        </span>
                        <input class="form-control" placeholder="Pihak Lainnya.." name="atas_nama" type="text">
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="laboratorium_id">Unit Laboratorium yang dituju:</label>
                      <select class="form-control" id="laboratorium_id" name="laboratorium_id"><option value="" selected="selected">-- Pilih Laboratorium -- </option><option value="1">Lab. Bahan Konstruksi Teknik</option><option value="5">Lab. Hidrolika</option><option value="6">Lab. Jalan Raya</option><option value="7">Lab. Komputasi</option><option value="8">Lab. Mekanika Tanah</option><option value="10">Lab. Rekayasa Transportasi</option><option value="11">Lab. Mekanika Rekayasa</option><option value="12">Lab. GIS &amp; Seismik</option><option value="15">Lab Dummy</option></select>
                    </div>
                  </div>
              ...
              <div class="card-footer" align="right">
                <a href="aktivitas-order-pengguna2.php" class="btn btn-primary" type="submit" value="Mendaftar Nomor Order" >Mendaftar Nomor Order</a>
              </div>
            </div>
          </div>

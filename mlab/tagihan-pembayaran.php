...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Tagihan & Pembayaran
        <button type="button" class="btn btn-tool" data-bs-toggle="modal" data-bs-target="#modalBantuan" title="Bantuan"><i class="fas fa-question-circle"></i>
        </button>
      </h3>
        <p class="text-muted mb-0">Manajemen Tagihan Order Laboratorium</p>
    </div>
  </section>
      ...
      <table class="table table-bordered table-striped table-sm datatables1">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>11-Nov-2024</td>
            <td>-</td>
            <td><span class="badge bg-danger">Terhutang</span></td>
          ...
          <tr>
            <td>3</td>
            <td>00280424</td>
            <td>PT. Maju Lancar Tbk</td>
            <td>Mahasiswa (Internal)</td>
            <td>-</td>
            <td>19-Apr-2024</td>
            <td>-</td>
            <td><span class="badge bg-warning text-dark">Uang Muka</span></td>
            <td><span class="badge bg-primary">Sudah Bayar</span></td>
            <td>
              <button class="btn btn-sm btn-outline-info">Detail</button>
            </td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            <label class="form-label">Rentang Tanggal Tagihan</label>

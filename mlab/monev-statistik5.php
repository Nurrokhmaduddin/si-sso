...
<div class="row g-3 mb-3">
 ...
 <!-- TAB NAV (Semester) -->
           <ul class="nav nav-tabs">
            ...
            <li class="nav-item" onclick="window.location='monev-statistik5.php'"><a class="nav-link active">Parameter Pengujian</a></li>
...
<!--   <div class="card">
  ...
  <div class="card">
    ...
    <div class="card-body">
<button onclick="window.location='monev-parameter.html'">0</button>
<button onclick="window.location='monev-order1.html'">1</button>
<button onclick="window.location='monev-order2.html'">2</button>
<button onclick="window.location='monev-order3.html'">3</button>

...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Pengaduan Pelanggan
        <button type="button" class="btn btn-tool" data-bs-toggle="modal" data-bs-target="#modalBantuan" title="Bantuan"><i class="fas fa-question-circle"></i>
        </button>
      </h3>
        <p class="text-muted mb-0">Manajemen Pengaduan Pelanggan</p>
    </div>
  </section>
      ...
      <table class="table table-bordered table-striped table-sm datatables1">
        ...
        <tbody>
          ...
          <tr>
            <td>1</td>
            <td>ST00030326</td>
            <td>Karakterisasi GC-MS</td>
            <td><span class="badge bg-primary">Open</span></td>
            <td>March, 05 Mar 2026 14:36:27</td>
            <td>
              <button class="btn btn-sm btn-outline-info" onclick="window.location='pengaduan-pelanggan-detail.php'">Detail</button>
            </td>
          </tr>
          ...
          <tr>
            <td>2</td>
            <td>ST00020126</td>
            <td>Data yang kurang</td>
            <td><span class="badge bg-primary">Open</span></td>
            <td>January, 24 Jan 2026 09:54:33</td>
            <td>
          ...
          <tr>
            ...
            <td>Data yang kurang</td>
            <td><span class="badge bg-primary">Open</span></td>
            <td>January, 24 Jan 2026 09:54:28</td>
            <td>
              <button class="btn btn-sm btn-outline-info">Detail</button>
            </td>
          </tr>
          ...
          <tr>
            <td>4</td>
            <td>ST00261225</td>
            <td>Hasil analisis metode BET terbaca surface area nya nol</td>
            <td><span class="badge bg-success">Answered</span></td>
            <td>January, 13 Jan 2026 09:20:48</td>
            <td>
              <button class="btn btn-sm btn-outline-info">Detail</button>
            </td>
          </tr>
          ...
          <tr>
            <td>5</td>
            <td>ST00251025</td>
            <td>pengaduan terhadap lama nya respon</td>
            <td><span class="badge bg-secondary">Closed</span></td>
            <td>November, 21 Nov 2025 11:02:50</td>
            <td>
              <button class="btn btn-sm btn-outline-info">Detail</button>
            </td>
          </tr>

...
<div class="col-md-12">
          ...
          <div class="col-md-12 mb-2">
            <button class="btn btn-primary btn-block confirm-action" data-redirect="https://simlabts.tsipil-uii.ac.id/administrasi-layanan/daftar-order/e84203d3-4713-49f5-8579-ba4130e8ddcf/update-order" fdprocessedid="wrlml9">
              Update Tender Kontrak
            </button>
          </div>
        ...
        <div class="callout callout-info">
          <p>Tender Kontrak <span class="text-success"><strong>DIUPDATE</strong></span> pada tanggal:  11-Nov-2024. Menunggu keputusan persetujuan atau pembatalan order dari Pemberi Order</p>
        </div>

...
<div class="row g-3 mb-3">
 ...
 <!-- TAB NAV (Semester) -->
           <ul class="nav nav-tabs">
            <li class="nav-item" onclick="window.location='monev-statistik.php'"><a class="nav-link active">Pelanggan</a></li>
            <li class="nav-item" onclick="window.location='monev-statistik1.php'"><a class="nav-link ">Order Instrumentasi</a></li>
            <li class="nav-item" onclick="window.location='monev-statistik.php'"><a class="nav-link ">Order Kalibrasi</a></li>
            <li class="nav-item" onclick="window.location='monev-statistik3.php'"><a class="nav-link ">Pembatalan Order</a></li>
            <li class="nav-item" onclick="window.location='monev-statistik.php'"><a class="nav-link ">Metode Pengujian</a></li>
            <li class="nav-item" onclick="window.location='monev-statistik.php'"><a class="nav-link ">Parameter Pengujian</a></li>
            <li class="nav-item" onclick="window.location='monev-statistik.php'"><a class="nav-link ">Kinerja</a></li>
          </ul>
...
<!--   <div class="card">
  ...
  <div class="card">
    ...
    <div class="card-body">
<button onclick="window.location='monev-statistik.html'">0</button>
<button onclick="window.location='monev-statistik1.html'">1</button>
<button onclick="window.location='monev-statistik2.html'">2</button>
<button onclick="window.location='monev-statistik3.html'">3</button>
<button onclick="window.location='monev-statistik4.html'">4</button>
  </div>
</div>

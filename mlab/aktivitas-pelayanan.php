...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0"> Pelayanan Pengujian
        <button type="button" class="btn btn-tool" data-bs-toggle="modal" data-bs-target="#modalBantuan" title="Bantuan"><i class="fas fa-question-circle"></i>
        </button>
      </h3>
        <p class="text-muted mb-0">Monitoring tahapan pengujian laboratorium</p>
    </div>
  </section>
          ...
          <div class="card">
            <div class="card-body ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <b>Status:</b> Semua (selesai,diproses, dihentikan)
                </div>
<div class="col-md-6">
                  <b>Tahap:</b> Semua (penerbitan tagihan,
penerbitan instruksi kerja,
pengujian sampel,
pelaporan hasil uji,
      ...
      <table class="table table-sm table-bordered table-hover align-middle datatables1">
        ...
        <tbody>
          ...
          <tr>
            <td>1</td>
            <td>02690226</td>
            <td>Putri Ameilya Wijayanti</td>
            <td>Universitas Islam Indonesia</td>
            <td><span class="badge bg-info">Diproses</span></td>
            <td>21-Apr-2026</td>
            <td>Survei Kepuasan Pelanggan</td>
            <td>4</td>
            <td><button class="btn btn-sm btn-outline-info" onclick="window.location='aktivitas-pelayanan-detail.php'">Detail</button></td>
          </tr>

          <tr>
            <td>2</td>
            <td>02670226</td>
            <td>Faiz Nurul Qolbi</td>
            <td>Universitas Muhammadiyah Surakarta</td>
            <td><span class="badge bg-info">Diproses</span></td>
            <td>21-Apr-2026</td>
            <td>Pengujian Sampel</td>
            <td>5</td>
          ...
          <tr>
            <td>4</td>
            <td>02560226</td>
            <td>Melania Hanny Aryantie</td>
            <td>UGM</td>
            <td><span class="badge bg-info">Diproses</span></td>
            <td>21-Apr-2026</td>
            <td>Pelaporan Hasil Uji</td>
            <td>4</td>
            <td><button class="btn btn-sm btn-outline-info">Detail</button></td>
          </tr>
          ...
          <tr>
            <td>9</td>
            <td>02490226</td>
            <td>Muhamad Fajar Sidiq</td>
            <td>INSTIPER Yogyakarta</td>
            <td><span class="badge bg-info">Diproses</span></td>
            <td>15-Apr-2026</td>
            <td>Survei Kepuasan Pelanggan</td>
            <td>4</td>
          ...
          <tr>
            <td>10</td>
            <td>02480226</td>
            <td>Prof. Didik Prasetyoko, M.Sc</td>
            <td>Institut Teknologi Sepuluh Nopember</td>
            <td><span class="badge bg-info">Diproses</span></td>
            <td>21-Apr-2026</td>
            <td>Pelaporan Hasil Uji</td>

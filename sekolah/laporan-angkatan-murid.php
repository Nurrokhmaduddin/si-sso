<?php $page = 'laporan_angkatan_murid'; ?>
...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Rapot Angkatan Murid</h3>
        <p class="text-muted mb-0">Ringkasan Nilai & Kehadiran Angkatan</p>
    </div>
  </section>
      ...
      <table class="table table1 table-bordered table-striped table-sm datatables1">
        ...
        <tbody>
          <tr>
            ...
            <td>88</td>
            <td>24/25</td>
            <td class="text-success">Memuaskan</td>
          </tr>
          <tr>
            <td>2</td>
            <td>Siti</td>
          ...
          <tr>
            ...
            <td>70</td>
            <td>20/25</td>
            <td class="text-warning">Perlu Perbaikan</td>
          </tr>
        </tbody>
      </table>

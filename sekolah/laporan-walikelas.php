...
<div class="content-wrapper" style="min-height: 626.4px;">    
  ...
  <section class="content-header">
    <div class="container-fluid">
      <h3 class="mb-0">Rapot Walikelas</h3>
        <p class="text-muted mb-0">Ringkasan .........</p>
    </div>
  </section>
  ...
  <div class="row g-3 mb-4">
    ...
    <div class="col-md-3">
      <div class="card text-white bg-success">
        <div class="card-body text-center">
          <h4>8/10</h4>
          <p>Kegiatan Hari Ini Tercatat</p>
        </div>
      </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
      <div class="card text-white bg-primary">
        <div class="card-body text-center">
          <h4>15</h4>
          <p>Pesan Terkirim ke Orang Tua</p>
        </div>
      </div>
    </div>
  </div>
...
<!-- ========== CARD : Tabel  ========== -->
<div class="card">
  <div class="card-header"> Daftar Kegiatan dan Eviden</div>
  <div class="card-body">
